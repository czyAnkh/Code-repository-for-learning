...
public class RightAdapter extends BaseAdapter {
    ...
    private List<com.example.project5.FoodBean> list;
    public RightAdapter(Context context ,List<com.example.project5.FoodBean> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        com.example.project5.FoodBean bean=list.get(position);
