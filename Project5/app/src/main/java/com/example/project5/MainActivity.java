...
public class MainActivity extends AppCompatActivity {
    ...
    private int[] imgs2 = {R.drawable.must_buy_three, R.drawable.must_buy_two,
            R.drawable.must_buy_three};
    private Map<String,List<com.example.project5.FoodBean>> map;
    @Override
    ...
    private void setData(){
        map=new HashMap<>();
        List<com.example.project5.FoodBean> list1=new ArrayList<>();
        List<com.example.project5.FoodBean> list2=new ArrayList<>();
        for (int i=0;i<names1.length;i++){
            com.example.project5.FoodBean bean=new com.example.project5.FoodBean();
     ...
     */
    public void switchData(List<com.example.project5.FoodBean> list) {
